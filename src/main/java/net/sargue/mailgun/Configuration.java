...
public class Configuration {
  ...
  private List<Converter<?>> converters = Collections.synchronizedList(new ArrayList<Converter<?>>());
  ...
  /**
   * @param configurator A valid {@link HttpClientConfigurator} used to add additional configuration settings
   * on the internal http client used.
   * @return this configuration
   */
  public Configuration withHttpClientConfigurator(final HttpClientConfigurator configurator) {
    this.httpClientConfigurator = configurator;
    return this;
  }
